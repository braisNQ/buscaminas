    ...
    class usuario
    {
         ...
         */
         ...
         function editar($nome, $pass)
         {
            ...
            $p = mysqli_real_escape_string($this->bd->conexion, $pass);
            $sql = "update usuario set nome = '".$n."', pass = '".$p."' where ID = '".$this->id."'";
        ...
        function eliminar()
        {        
            $sql = "delete from partida where id_usuario='".$this->id."'";        
        ...
        /*
        * función rexistraScore($tempo, $dimension)
        * inserta na BD un novo resultado para o usuario
        * devolve o resultado de executar a consulta
        */
        function rexistraScore($tempo, $dimension)
        {
            $sql = "insert into partida (id_usuario, tempo, dimension, data) values ('".$this->id."', '".$tempo."', '".$dimension."', CURDATE())";
            return mysqli_query($this->bd->conexion, $sql);
        }
    }
