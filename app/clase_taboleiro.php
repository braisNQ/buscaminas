		        	...
		        	<div class="form-group">
		          		<div class="col-sm-6">
		            		<div class="input-group">
		              			...
		              			<input type="text" class="form-control" id="inputTempo" name="inputTempo" value=0 readonly>
		            		</div>
		          		</div>
		          		<div class="col-sm-6">
		            		<div class="input-group">
		              			<span class="input-group-addon glyphicon glyphicon-asterisk"></span>
		              			<input type="text" class="form-control" id="inputMinas" name="inputMinas" value="'.$this->minas.'" readonly>
		          	 	 	</div>
		          		</div>
		        	</div>
